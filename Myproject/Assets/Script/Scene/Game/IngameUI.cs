...
public class IngameUI : MonoBehaviour
{
    ...
    private void CloseNextRound()
    {
        ...
        GameManager.instance.tools.Move_Local_XY(eDir.Y, _objNextRound.GetComponent<RectTransform>(), -1320f, 0.5f, 0, Ease.InBack, () => 
        {
            _objNextRound.SetActive(false);
        });
    }
    ...
    public void OpenNextRoundWindow(eRoundClear type, string content = null)
    {
        ...
        GameManager.instance.tools.Move_Local_XY(eDir.Y, _objNextRound.GetComponent<RectTransform>(), -600f, 0.5f, 0, Ease.OutBack, null);
    }
